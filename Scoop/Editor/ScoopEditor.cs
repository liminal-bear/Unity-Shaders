...
public class ScoopEditor : ShaderGUI
{
    ...
    void DrawUI()
    {
        ...
        MaterialProperty paintTex = FindProperty("_PaintTex", properties);

        //GUIContent paintTexLabel = new GUIContent("Paint Texture", "paint texture color");
        //MaterialProperty PaintLerpSlider = FindProperty("_PaintLerp", properties);
        //editor.TexturePropertySingleLine(paintTexLabel, paintTex, PaintLerpSlider);

        //MaterialProperty emissionColor = FindProperty("_EmissionColor", properties);
        //editor.TexturePropertySingleLine(paintTexLabel, paintTex);
        //editor.TextureScaleOffsetProperty(paintTex);
        ...
        //MaterialProperty paintTex2 = FindProperty("_PaintTex2", properties);

        //GUIContent paintTexLabel2 = new GUIContent("Paint Texture2", "paint texture color");
        //MaterialProperty PaintLerpSlider2 = FindProperty("_PaintLerp2", properties);
        //editor.TexturePropertySingleLine(paintTexLabel2, paintTex2, PaintLerpSlider2);
        //editor.TextureScaleOffsetProperty(paintTex2);
        ...
        GUILayout.Label("Roughness & Specular", EditorStyles.boldLabel);
        ...
        GUIContent specColorLabel = new GUIContent("specColor", "color of specular highlight");
        GUIContent specularARXLabel = new GUIContent("Specular Aspect Ratio X", "Defines shape of specular highlight");
        GUIContent specularARYLabel = new GUIContent("Specular Aspect Ratio Y", "Defines shape of specular highlight");
        MaterialProperty AlphaXSlider = FindProperty("_AlphaX", properties);
        MaterialProperty AlphaYSlider = FindProperty("_AlphaY", properties);
        editor.ShaderProperty(specColor, specColorLabel);
        editor.ShaderProperty(AlphaXSlider, specularARXLabel);
        editor.ShaderProperty(AlphaYSlider, specularARYLabel);
