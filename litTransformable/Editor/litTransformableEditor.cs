...
public class LitTransformableEditor : ShaderGUI
{
    ...
    void DrawUI()
    {
        ...
        MaterialProperty axisAdjust = FindProperty("_AxisAdjust", properties);
        GUIContent axisAdjustLabel = new GUIContent("Axis adjust", "Controls the scale of the object (visual only)");
        editor.ShaderProperty(axisAdjust, axisAdjustLabel);
